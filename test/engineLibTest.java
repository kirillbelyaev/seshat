...
public class engineLibTest {
	...
	@Test
	public void hello() {
		String XMLmessage = "<XML_MESSAGE length=\"00002120\" version=\"0.4\" xmlns=\"urn:ietf:params:xml:ns:xfb-0.4\" "
				+ "type_value=\"2\" type=\"UPDATE\">"
				+ "<PEERING as_num_len=\"2\">"
				+ "<SRC_ADDR>"
				+ "<ADDRESS>129.82.138.6</ADDRESS>"
				+ "<AFI value=\"1\">IPV4</AFI>"
				+ "</SRC_ADDR>"
				+ "<SRC_PORT>4321</SRC_PORT>"
				+ "<SRC_AS>6447</SRC_AS>"
				+ "<DST_ADDR>"
				+ "<ADDRESS>89.149.178.10</ADDRESS>"
				+ "<AFI value=\"1\">IPV4</AFI>"
				+ "</DST_ADDR>"
				...
				+ "<UPDATE withdrawn_len=\"0\" path_attr_len=\"52\">"
				+ "<WITHDRAWN count=\"0\"/>"
				...
				+ "<AS_PATH>"
				+ "<AS_SEG type=\"AS_SEQUENCE\" length=\"3\">"
				+ "<AS>3257</AS>"
				+ "<AS>6453</AS>"
				+ "<AS>13156</AS>"
				+ "</AS_SEG>"
				...
				+ "<NEXT_HOP>89.149.178.10</NEXT_HOP>"
				+ "</ATTRIBUTE>"
				+ "<ATTRIBUTE length=\"4\">"
				+ "<FLAGS optional=\"TRUE\"/>"
				+ "<TYPE value=\"4\">MULTI_EXIT_DISC</TYPE>"
				+ "<MULTI_EXIT_DISC>10</MULTI_EXIT_DISC>"
				+ "</ATTRIBUTE>"
				+ "<ATTRIBUTE length=\"20\">"
				+ "<FLAGS optional=\"TRUE\" transitive=\"TRUE\"/>"
				...
				+ "<NLRI count=\"1\">"
				+ "<PREFIX label=\"NANN\">"
				+ "<ADDRESS>217.129.92.0/22</ADDRESS>"
				+ "<AFI value=\"1\">IPV4</AFI>"
				...
				+ "</ASCII_MSG>"
				+ "<OCTET_MSG>"
				+ "<OCTETS length=\"79\">FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF004F02000000344001010040020802030CB9193533644003045995B20A8004040000000AC008140CB91F8C0CB9759D0CB9C3520CB9C8640CB9C86516D9815C</OCTETS>"
				+ "</OCTET_MSG>" + "</XML_MESSAGE>";

		String Query = "MULTI_EXIT_DISC	= 10 & SRC_AS =	6447 & DST_PORT = 179 & path_attr_len = 52";
		String Query0 = "type % AS_";
		String Query1 = "transitive = \"TRUE\"";
		...
		// complex expression should not be working anymore in the current implementation
		...
		/*
		 * engine.addQuery(Query5); engine.addQuery(Query3);
		 * engine.addQuery(Query4); engine.addQuery(Query5);
		 */
